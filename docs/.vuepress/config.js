module.exports = {
    ...
    base:'https://webxiaoma.github.io/web-plugins/docs/blogs/', // 部署站点的基础路径
    dest: "./blogs", //输出目录
    ...
    themeConfig: {  // 导航
        ...
        nav: [  // 导航栏 使用了element 导航
            { text: 'JS插件库', items:[
                {text: "img-lazy图片懒加载", link: '/js-plugins/img-lazy' },
                {text:"js-encryption前端加密", link:'/js-plugins/js-encryption'},
            ]},
        ],
        sidebar: {  // 侧边栏
            "/js-plugins/":[
       ...
       serviceWorker: {
        ...
        // 假如你的文档仓库和项目本身不在一个仓库：
        docsRepo: 'webxiaoma/web-plugins/docs/blogs',
        // 假如文档不是放在仓库的根目录下：
        docsDir: '/docs/blogs',
        // 假如文档放在一个特定的分支下：
        docsBranch: 'master',
